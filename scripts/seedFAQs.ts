...
const client = createClient({
    ...
    token: process.env.SANITY_AUTH_TOKEN, // Ensure you have this env var set or rely on --with-user-token
    useCdn: false,
})
...
const faqs = [
    ...
    },
    {
        ...
        answer: "Timeline varies by scope, but we pride ourselves on on-time delivery. A typical 50,000 sq. ft. industrial shed takes approximately 6-8 months from groundbreaking to handover.",
        order: 4
    },
    {
        _type: 'faq',
